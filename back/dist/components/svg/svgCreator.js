...
exports.generateGeneralDoorSvg = generateGeneralDoorSvg;
exports.generateFlapDoorSvg = generateFlapDoorSvg;
exports.generateMaedaDoorSvg = generateMaedaDoorSvg;
...
const DOOR_DIMENSION_POSITIONS = {
    // 좌경
    '좌경_2보링': {
        verticalPos: {
...
const FLAP_DOOR_DIMENSION_POSITIONS = {
    '2보링': {
        verticalPos: {
...
// 일반문 SVG 생성 함수
function generateGeneralDoorSvg(subtype, size, color = {}, boringValues) {
...
// 플랩문 SVG 생성 함수
function generateFlapDoorSvg(subtype, size, color = {}, boringValues) {
    const svg = document.createElementNS(SVG_NS, 'svg');
    svg.setAttribute('width', '1200');
    svg.setAttribute('height', '1200');
    svg.setAttribute('viewBox', '0 0 1200 1200');
...
// 마에다 서랍 SVG 생성 함수
function generateMaedaDoorSvg(subtype, size, color) {
...
// 치수 텍스트 삽입 함수들
function insertDimensionTexts(svg, subtype, size, boringValues) {
