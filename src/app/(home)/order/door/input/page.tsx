...
function DoorInfoInputPage() {
    ...
    useEffect(() => {
        setBoringSize(prev =>
            Array.from({ length: boringNum }, (_, i) => prev[i] ?? 0)
        );
    }, [boringNum]);
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-5 px-5">
                <BoxedSelect label="색상" options={[]} value={""} onChange={function (value: string): void {
                ...
                <SegmentedControl options={[]} value={0} onChange={function (index: number): void {
                    throw new Error("Function not implemented.");
                }} />
