...
function ColorList() {
  ...
  const currentCategory = DOOR_CATEGORY_LIST.find(item => item.slug === category);
  let header = "문짝";
  if (category === "normal") header = "일반문";
  else if (category === "flap") header = "플랩문";
  else if (category === "drawer") header = "서랍";
