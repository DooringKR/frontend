...
function FlapDoorAdditionalPageContent() {
    ...
    useEffect(() => {
        ...
        setScreenName('door_flap_additional');
...
function FlapDoorAdditionalPage() {
    return (
        <Suspense fallback={<div>로딩 중...</div>}>
            <FlapDoorAdditionalPageContent />
        </Suspense>
    );
}

export default FlapDoorAdditionalPage;
