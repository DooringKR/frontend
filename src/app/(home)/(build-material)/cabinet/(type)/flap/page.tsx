...
function FlapCabinetPageContent() {
    ...
    const button1Disabled = isFormValid() || (bodyMaterial === null && !bodyMaterialDirectInput) || !handleType || !behindType || !absorber_type || (cabinet_construct === null) || (legType === null && !legTypeDirectInput);
