        ...
        <div className="w-full">
          ...
          {showDetails && (
            <div className="mt-2 rounded-xl bg-white p-5 text-sm">
              ...
              <div className="mb-2 border-b border-gray-200 pb-3 text-gray-500">
              ...
              <div className="mb-2 border-b border-gray-200 pb-3 text-gray-500">
                <p className="mb-1 text-[17px] font-600 text-gray-800">현장에서 받는 분 연락처</p>
                <p>{order.recipientPhoneNumber}</p>
              </div>

              <div className="mb-2 text-gray-500">
                <p className="mb-1 text-[17px] font-600 text-gray-800">바로가구 요청사항</p>
