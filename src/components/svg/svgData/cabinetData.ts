...
export const DRAWER_CABINET_PARTS: Record<string, SvgPart[]> = {
  // 2단 서랍장 (SVG 예시 그대로)
  drawer2: [
    // 레일
    {
...
export const FLAP_CABINET_PARTS: SvgPart[] = [
  // 바닥
  { d: "M464 720L260 864L656 960L860 816L464 720Z", fill: "#F3F4F6", stroke: "black", strokeWidth: "4", strokeLinejoin: "round" },
  // 우측면
  { d: "M860 336L464 240V720L860 816V336Z", fill: "#F3F4F6", stroke: "black", strokeWidth: "4", strokeLinejoin: "round" },
...
// 상부장 문 파트 (좌측문, 우측문)
export const UPPER_CABINET_DOOR_PARTS: Record<string, SvgPart> = {
  leftDoor: {
